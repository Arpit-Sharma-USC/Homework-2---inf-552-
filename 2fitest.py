...
while counter < chunks:
    ...
    y = []
    for i in range(0, 19):
        if (i in range(0, 4)):  # bending(1&2)
            y.append(1)
        elif (i in range(4, 7)):  # cycling
            y.append(2)
        elif (i in range(7,10)):  # lying
            y.append(3)
        elif (i in range(10, 13)):  # sitting
            y.append(4)
        elif (i in range(13, 16)):  # standing
            y.append(5)
        elif (i in range(16, 19)):  # walking
            y.append(6)
    ...
    print(my_dataframe)
    pd.DataFrame.to_csv(my_dataframe,path_or_buf='C:/Users/Shanu/PycharmProjects/Arem/AReM/my_dataset_test_multiclass.csv',index=False)
