...
while counter < chunks:
    ...
    bending_min_single_array = np.array(bending_min_series_1)
    bending_min_single_array_ravelelled = bending_min_single_array.ravel()
    bending_min_single_array_ravelelled_1_split_array = np.array(bending_min_single_array_ravelelled)

    bending_min_series_2 = []
    bending_min_series_2 = feature_min_2[0:2]
    bending_min_single_array = np.array(bending_min_series_2)
    bending_min_single_array_ravelelled = bending_min_single_array.ravel()
    bending_min_single_array_ravelelled_2_split_array = np.array(bending_min_single_array_ravelelled)

    bending_min_series_3 = []
    bending_min_series_3 = feature_min_3[0:2]
    bending_min_single_array = np.array(bending_min_series_3)
    bending_min_single_array_ravelelled = bending_min_single_array.ravel()
    bending_min_single_array_ravelelled_3_split_array = np.array(bending_min_single_array_ravelelled)

    bending_min_series_4 = []
    bending_min_series_4 = feature_min_4[0:2]
    bending_min_single_array = np.array(bending_min_series_4)
    bending_min_single_array_ravelelled = bending_min_single_array.ravel()
    bending_min_single_array_ravelelled_4_split_array = np.array(bending_min_single_array_ravelelled)

    bending_min_series_5 = []
    bending_min_series_5 = feature_min_5[0:2]
    bending_min_single_array = np.array(bending_min_series_5)
    bending_min_single_array_ravelelled = bending_min_single_array.ravel()
    bending_min_single_array_ravelelled_5_split_array = np.array(bending_min_single_array_ravelelled)

    bending_min_series_6 = []
    bending_min_series_6 = feature_min_6[0:2]
    bending_min_single_array = np.array(bending_min_series_6)
    bending_min_single_array_ravelelled = bending_min_single_array.ravel()
    bending_min_single_array_ravelelled_6_split_array = np.array(bending_min_single_array_ravelelled)
    ...
    bending_max_single_array_ravelelled_1_split_array = np.array(bending_max_single_array_ravelelled)

    bending_max_series_2 = []
    bending_max_series_2 = feature_max_2[0:2]
    bending_max_single_array = np.array(bending_max_series_2)
    bending_max_single_array_ravelelled = bending_max_single_array.ravel()
    bending_max_single_array_ravelelled_2_split_array = np.array(bending_max_single_array_ravelelled)

    bending_max_series_3 = []
    bending_max_series_3 = feature_max_3[0:2]
    bending_max_single_array = np.array(bending_max_series_3)
    bending_max_single_array_ravelelled = bending_max_single_array.ravel()
    bending_max_single_array_ravelelled_3_split_array = np.array(bending_max_single_array_ravelelled)

    bending_max_series_4 = []
    bending_max_series_4 = feature_max_4[0:2]
    bending_max_single_array = np.array(bending_max_series_4)
    bending_max_single_array_ravelelled = bending_max_single_array.ravel()
    bending_max_single_array_ravelelled_4_split_array = np.array(bending_max_single_array_ravelelled)

    bending_max_series_5 = []
    bending_max_series_5 = feature_max_5[0:2]
    bending_max_single_array = np.array(bending_max_series_5)
    bending_max_single_array_ravelelled = bending_max_single_array.ravel()
    bending_max_single_array_ravelelled_5_split_array = np.array(bending_max_single_array_ravelelled)

    bending_max_series_6 = []
    bending_max_series_6 = feature_max_6[0:2]
    bending_max_single_array = np.array(bending_max_series_6)
    bending_max_single_array_ravelelled = bending_max_single_array.ravel()
    bending_max_single_array_ravelelled_6_split_array = np.array(bending_max_single_array_ravelelled)
    ...
    bending_mean_single_array_ravelelled_1_split_array = np.array(bending_mean_single_array_ravelelled)
    ...
    bending_mean_single_array_ravelelled = bending_mean_single_array.ravel()
    bending_mean_single_array_ravelelled_2_split_array = np.array(bending_mean_single_array_ravelelled)
    ...
    bending_mean_single_array_ravelelled = bending_mean_single_array.ravel()
    bending_mean_single_array_ravelelled_3_split_array = np.array(bending_mean_single_array_ravelelled)

    bending_mean_series_4 = []
    bending_mean_series_4 = feature_mean_4[0:2]
    bending_mean_single_array = np.array(bending_mean_series_4)
    bending_mean_single_array_ravelelled = bending_mean_single_array.ravel()
    bending_mean_single_array_ravelelled_4_split_array = np.array(bending_mean_single_array_ravelelled)

    bending_mean_series_5 = []
    bending_mean_series_5 = feature_mean_5[0:2]
    bending_mean_single_array = np.array(bending_mean_series_5)
    bending_mean_single_array_ravelelled = bending_mean_single_array.ravel()
    bending_mean_single_array_ravelelled_5_split_array = np.array(bending_mean_single_array_ravelelled)

    bending_mean_series_6 = []
    bending_mean_series_6 = feature_mean_6[0:2]
    bending_mean_single_array = np.array(bending_mean_series_6)
    bending_mean_single_array_ravelelled = bending_mean_single_array.ravel()
    bending_mean_single_array_ravelelled_6_split_array = np.array(bending_mean_single_array_ravelelled)
    ...
    data={'Series-1-min':c_1_min,
    'Series-2-min':c_2_min,
    'Series-2-min':c_2_min,
    'Series-3-min':c_3_min,
    'Series-4-min':c_4_min,
    'Series-5-min':c_5_min,
    'Series-6-min':c_6_min,
    'Series-1-max':c_1_max,
    'Series-2-max':c_2_max,
    'Series-2-max':c_2_max,
    'Series-3-max':c_3_max,
    'Series-4-max':c_4_max,
    'Series-5-max':c_5_max,
    'Series-6-max':c_6_max,
    'Series-1-mean': c_1_mean,
    'Series-2-mean': c_2_mean,
    'Series-2-mean': c_2_mean,
    'Series-3-mean': c_3_mean,
    'Series-4-mean': c_4_mean,
    'Series-5-mean': c_5_mean,
    'Series-6-mean': c_6_mean,
    'Target':y}

    my_dataframe=pd.DataFrame(data)
    print(my_dataframe)
    pd.DataFrame.to_csv(my_dataframe,path_or_buf='C:/Users/Shanu/PycharmProjects/Arem/AReM/my_dataset_test.csv',index=False)
