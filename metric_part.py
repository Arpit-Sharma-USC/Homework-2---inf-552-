...
for i in range(1,11):
    knnclassifier=KNeighborsClassifier(n_neighbors=1,metric='minkowski',p=pow(10,i), algorithm='ball_tree')
...
# trace = go.Table(
#     header=dict(values=['Minkowski(log)=0.1','Minkowski(log)=0.2','Minkowski(log)=0.3','Minkowski(log)=0.4','Minkowski(log)=0.5','Minkowski(log)=0.6','Minkowski(log)=0.7','Minkowski(log) 0.8','Minkowski(log)=0.9','Minkowski(log) 1.0' ]),
