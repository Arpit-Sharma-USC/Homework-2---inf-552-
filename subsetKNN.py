...
for img_index in misclassifiedIndexes:
    ...
    img = x_train[[image_indices[neighbour_index]],:].reshape(28,28)#this is the neighbour
    img_plot_index = img_plot_index + 1
    plt.subplot(10, 5, img_plot_index)
...
#     plt.imshow(img,cmap=plt.cm.gray)
#     print("hello")
#     # plt.title('K(1)-Nearest Neighbor of missclassified samples')
plt.show()



#confusion matrix
# cm = metrics.conxfusion_matrix(y_test, predictions)
