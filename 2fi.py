...
while counter < chunks:
    ...
    y = []
    for i in range(0, 69):
        if (i in range(0, 9)):#bending(1&2)
            y.append(1)
        elif (i in range(9,21)): #cycling
            y.append(2)
        elif (i in range(21, 33)):  # lying
            y.append(3)
        elif (i in range(33,45)):  # sitting
            y.append(4)
        elif (i in range(45, 57)):  # standing
            y.append(5)
        elif (i in range(57, 69)):  # walking
            y.append(6)
    ...
    print(my_dataframe)
    pd.DataFrame.to_csv(my_dataframe,path_or_buf='C:/Users/Shanu/PycharmProjects/Arem/AReM/my_dataset_multiclass.csv',index=False)
